...
> **Status: Fase 12 — Dashboard operativo (operational dashboard): spec + UX + QA.** This repository currently contains
...
- [docs/ux](./docs/ux) — design system, routes and components (incl. trucks, Fase 7; cargo, Fase 8; movements timeline, Fase 9; special areas, Fase 10; operational map, Fase 11; operational dashboard, Fase 12)
- [docs/security](./docs/security) — threat model and RLS matrix
- [docs/qa](./docs/qa) — QA and testing strategy (incl. trucks, Fase 7; cargo, Fase 8; movement engine, Fase 9; special areas, Fase 10; operational map, Fase 11; operational dashboard, Fase 12)
